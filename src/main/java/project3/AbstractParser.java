...
/**
 * Abstract base class for JSON content parsers that implements the Visitor pattern. Provides common
 * functionality for parsing and validating content from different sources.
 *
    ...
    if (!missingFields.isEmpty()) {
      ...
      throw new IllegalArgumentException(
          String.format(
              ...
              identifier, String.join(", ", missingFields)));
    }
  }
