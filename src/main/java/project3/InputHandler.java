...
/**
 * Handles user input for selecting news source and format types.
 * Provides an interactive command-line interface for user choices.
 */
public class InputHandler {
    ...
    /**
     * Gets the user's preferred format type through command-line interaction.
     * Automatically selects NewsAPI format for URL sources.
     *
