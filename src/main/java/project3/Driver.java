...
public class Driver {
    /**
     * Main method that runs the news parser application.
     * Manages the user interaction flow and handles any errors that occur during execution.
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\nCheck " + LoggerConfiguration.getInstance().getLogPath() +
