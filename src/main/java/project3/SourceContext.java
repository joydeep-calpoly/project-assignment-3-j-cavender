...
/**
 * Interface for implementing the Visitor pattern for different source types.
 * Defines the contract for source contexts that can be visited by parser visitors.
 */
