...
public enum SourceType {
    ...
    /**
     * Converts a string input to the corresponding SourceType enum value.
     * This method supports both numeric and text-based input formats for flexibility.
     *
     * @param input The string to convert. Valid inputs are:
     *        "file" or "1" for FILE type
     *        "url" or "2" for URL type
